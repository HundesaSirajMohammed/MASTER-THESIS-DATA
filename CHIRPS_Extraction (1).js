 ...
 * Also extracts daily precipitation values as a CSV for further analysis.  
 *  
...
// ===================== //
// 2. LOAD CHIRPS DAILY PRECIPITATION DATASET //
// ===================== //
...
// ===================== //
// 3. COMPUTE ANNUAL TOTAL PRECIPITATION //
// ===================== //
...
Export.image.toDrive({
    ...
    description: 'CHIRPS_Avg_Annual_Precip_1999_2002',
    scale: 5566,
    region: roi,
    fileFormat: 'GeoTIFF'
});
...
// ===================== //
// 5. COMPUTE DAILY PRECIPITATION AND EXPORT AS CSV //
// ===================== //
